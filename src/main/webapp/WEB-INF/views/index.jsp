...
<body class="slides chain simplifiedMobile animated">
  ...
  <nav class="sidebar" data-sidebar-id="1">
    ...
    <div class="content">
      ...
      <ul class="subMenu small opacity-8">
        <li><a href="/member/myPage?cm_id=${member.cm_id}">마이페이지</a></li>
  ...
  <section class="slide fade-6 kenBurns">
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <p class="ae-3"><span class="opacity-8" style="font-family: 'Nanum Pen Script', cursive; font-size: 50px;" style="margin-bottom: 100px;">오늘은
              어디로 떠나볼까?</span></p>
          <form class="slides-form" action="#" autocomplete="off" style="margin-bottom: 120px;">
            <input type="text" class="input-9 ae-4 fromCenter" name="user-email" placeholder="검색어를 입력해주세요" />
            <button type="submit" class="button blue gradient ae-7 fromCenter" name="button">검색하기</button>
          </form>
        </div>
    ...
    <div class="background" style="background-image:url(assets/img/background/bg_car.jpg)"></div>
  </section>
  ...
  <section class="slide fade-6 kenBurns">
    ...
    <div class="background" style="background-image:url(assets/img/background/bg_5.jpg)"></div>
  </section>
  <!-- Slide 2 (#15) -->
  <section class="slide fade-6 kenBurns fromLeft">
    ...
    <div class="background" style="background-image:url(assets/img/background/camp_shop.jpg)"></div>
  </section>
  <!-- Slide 4 (#74) -->
  <section class="slide fade-6 kenBurns">
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-10-12 toCenter">
            ...
            <p class="ae-2"><span class="opacity-8">합리적인,</span></p>
          </div>
          <div class="fix-12-12">
              ...
              <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-3 fromCenter">
                <a href="#" class="box-74">
                  <div class="thumbnail-74" style="width: 100%;height: 100%;">
                    <img src="assets/img/background/store2.jpg" class="wide" alt="Thumbnail" />
                  </div>
              ...
              <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-4 fromCenter">
                <a href="#" class="box-74">
                  <div class="thumbnail-74">
                    <img src="assets/img/background/store1.png" class="wide" alt="Thumbnail" />
                  </div>
                  <div class="name-74 equalElement table wide">
                    <div class="cell left top">
    ...
    <div class="background" style="background-image:url(assets/img/background/camp_stuff.jpg)"></div>
  </section>
...
<section class="slide fade-6 kenBurns">
        ...
        <div class="fix-12-12">
          <ul class="flex left">
            <li class="col-6-12 fromBottomLeft">
              ...
              <div class="ae-3"><p class="opacity-8">캠핑에 유용한 정보를 제공합니다. 캠핑 팁을 얻어가세요!</p></div>
              <ul class="flex">
            ...
            <li class="col-5-12 bottom">
              <div class="videoThumbnail shadow rounded popupTrigger margin-bottom-3 ae-7" data-popup-id="89-3">
                <img src="assets/img/background/camp_spot3.jpg" class="wide" alt="Video Thumbnail"/>
              </div>
              <img src="assets/img/background/camp_spot1.jpg" data-action="zoom" class="shadow rounded ae-8" alt="Image"/>
            </li>
          </ul>
        </div>
  ...
  <div class="background" style="background-image:url(assets/img/background/camp_information.jpg)"></div>
</section>
...
<div class="popup autoplay" data-popup-id="89-3">
      ...
      <div class="wrap">
        <div class="fix-10-12">
          <div class="embedVideo popupContent">
            <iframe src="https://www.youtube.com/embed/7gZJjxEu1Q0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="slide fade-6 kenBurns">
              ...
              <li class="col-12-12 col-tablet-1-2 col-phablet-1-1 ae-4">
                <div class="pad">
                  ...
                  <div class="price ae-6">
                    <div class="thumbnail-74">
                      <img src="assets/img/background/camp_spot3.jpg" class="wide" alt="Thumbnail" />
                    </div>
                  ...
                  <div class="margin-top-3 margin-bottom-3 equalElement ae-7">
                    <ul class="p tiny">
                      <li><strong>제목: 여기 캠핑장 너무 좋아요!</strong></li>
                      
                      <li class="opacity-8">네이버 검색하면 나오는 구도항은 주차장이 넓고 인근섬을 가는 배편의 선착장 바로 앞이라

                        간단히 낚시 (잡히는지는 모르겠으나,)가 가능합니다.
                        
                        주차장에 주차하시고 자리편뒤, 공터에서 놀거나 낚시하는 휴식입니다.</li>
                      
                    </ul>
                    <div class="thumbnail-74"  style="width:100px;height: 100px;">
                      <img src="assets/img/background/star.png" class="wide" alt="Thumbnail"/>
                    </div>
                  </div>
                  <a href="#" class="button blue gradient wide cropSides cropBottom ae-8">구경하러 가기</a>
                </div>
              </li>
    ...
    <div class="background" style="background-image:url(assets/img/background/camp_after.jpg)"></div>
  </section>
  ...
  <section class="slide fade-6 kenBurns">
            ...
            <ul class="grid equal fixedSpaces margin-top-3">
              <li class="col-4-12 ae-3">
                <div class="fix-3-12 equalElement">
                  ...
                  <p class="tiny"><a class="opacity-8" href="#">서울특별시 중구 남대문로 120 대일빌딩<br> 2층</a></p>
                </div>
                <div class="fix-3-12 equalElement">
                  <h6 class="uppercase opacity-4 margin-top-3 margin-bottom-2">종로지점</h6>
                  <p class="tiny"><a class="opacity-8" href="#">서울특별시 중구 남대문로 120 대일빌딩 <br> 3층 E Class</a></p>
                </div>
              </li>
              <li class="col-4-12 ae-4">
                <div class="fix-3-12 equalElement">
                  <h6 class="uppercase opacity-4 margin-top-3 margin-bottom-2">광고 및 제휴문의</h6>
                  <p class="tiny"><a class="opacity-8" href="mailto:#">seethestars@gmail.com</a></p>
                </div>
                <div class="fix-3-12 equalElement">
              ...
              <li class="col-4-12 ae-5">
                <div class="fix-3-12 equalElement">
                  ...
                  <p class="tiny"><a class="opacity-8" href="#">02-1544-9970</a>
                  </p>
                </div>
                <div class="fix-3-12 equalElement">
    ...
    <div class="background" style="background-image:url(assets/img/background/bg_3.jpg)"></div>
  </section>
